/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5ba3ee0b247904f26fac0462823f9326)
...
declare namespace Cloudflare {
	...
	interface Env {
		databaseKV: KVNamespace;
		ALLOW_NEW_DEVICE: string | undefined;
		ALLOW_QUERY_NUMS: string | undefined;
		ROOT_PATH: '/';
		database: D1Database;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'ALLOW_NEW_DEVICE' | 'ALLOW_QUERY_NUMS' | 'ROOT_PATH'>> {}
}
